	  ...
	  ui(new Ui::OBSBasic)
{
	...
	stringstream name;
	name << "Smartway OBS " << App()->GetVersionString();
...
void OBSBasic::UploadLog(const char *subdir, const char *file, const bool crash)
{
	...
	stringstream ss;
	ss << "Smartway OBS " << App()->GetVersionString(false)
...
void OBSBasic::SystemTrayInit()
{
	...
	trayIcon->setToolTip("Smartway OBS Studio");
			     ...
			     QSystemTrayIcon::MessageIcon n)
{
	if (trayIcon && trayIcon->isVisible() &&
		...
		QSystemTrayIcon::MessageIcon icon =
			QSystemTrayIcon::MessageIcon(n);
		trayIcon->showMessage("Smartway OBS Studio", text, icon, 10000);
	}
}
